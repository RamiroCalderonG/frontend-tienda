    ...
    return SingleChildScrollView(
      ...
      child: Wrap(
        ...
        children: [
          ...
          _StatCard(label: 'Costo de ventas', value: fmtMoney.format(resumen!.costoVentas),
              icon: Icons.price_change_outlined, color: Colors.orange),
          _StatCard(label: 'Ganancia bruta', value: fmtMoney.format(resumen!.ganancia),
          ...
          _StatCard(label: 'Inversión restocks', value: fmtMoney.format(resumen!.inversion),
              icon: Icons.warehouse_outlined, color: Colors.purple),
        ],
      ),
    );
  }
